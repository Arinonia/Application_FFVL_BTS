...
public class Circle extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rectF = new RectF(); rectF.set(this.strokeWidth, this.strokeWidth,this.getWidth() - this.strokeWidth ,this.getWidth() - this.strokeWidth);
